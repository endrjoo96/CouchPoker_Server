...
using static CouchPoker_Server_UnitTests.Misc;

namespace CouchPoker_Server_UnitTests
{
    public static class Misc
    {
        public static int repeats = 5000;
    ...
    [TestClass]
    public class FiguresTests_7cards
    {
        [TestMethod]
        public void FigureTest_HIGHCARD()
        {
            for (int tests = 0; tests < repeats; tests++)
            {
                ...
                if (s.Figure == FIGURE.STRAIGHT || s.Figure == FIGURE.POKER || s.Figure == FIGURE.ROYAL_POKER || s.Figure == FIGURE.FLUSH)
                {
                    tests--;
                    continue;
                }
        ...
        public void FigureTest_TWO_PAIRS()
        {
            for (int tests = 0; tests < repeats; tests++)
            {
                ...
                if (s.Figure == FIGURE.STRAIGHT || s.Figure == FIGURE.FLUSH ||
                    s.Figure == FIGURE.POKER || s.Figure == FIGURE.ROYAL_POKER) { continue; }
        ...
        public void FigureTest_FULL()
        {
            for (int tests = 0; tests < repeats; tests++)
            {
                ...
                List<VALUE> restrictedValues = new List<VALUE>() { card1.Value_Enum, card3.Value_Enum };
        ...
        public void FigureTest_STRAIGHT()
        {
            for (int tests = 0; tests < repeats; tests++)
            {
                ...
                foreach (var c in cards)
                {
                    restrictedValues.Add(c.Value_Enum);
                }
                for (int i = 0; i < 2; i++)
                {
                    Card newcard = GenerateCardWithout(restrictedValues.ToArray());
        ...
        public void FigureTest_ROYAL_POKER()
        {
            for (int tests = 0; tests < repeats; tests++)
            {
                ...
                TestCorrection(cards, s, FIGURE.ROYAL_POKER, repeats);
            }
        }
        ...
        public void FigureTest_FLUSH()
        {
            for (int tests = 0; tests < repeats; tests++)
            {
                ...
                if (s.Figure == FIGURE.STRAIGHT || s.Figure == FIGURE.POKER || s.Figure == FIGURE.ROYAL_POKER)
                {
                    tests--;
                    continue;
                }
